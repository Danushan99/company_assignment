...
function AddressTypeTableHeader(props) {
	...
	const adtTitle = findByKey(wordsList, 'ADT_TITLE');
	...
	const addressTypeTitle =
		currentLanguageId === 'en' ? adtTitle?.en_US : currentLanguageId === 'rus' ? adtTitle?.rus : 'Address Type';
...
export default AddressTypeTableHeader;
