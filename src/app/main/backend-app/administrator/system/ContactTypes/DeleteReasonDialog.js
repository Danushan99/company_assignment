...
import { removeContainerType } from './store/ContactTypesSlice';
...
function DeleteReasonDialog(props) {
	...
	const selectedIdsString = selectedIds.toString();
	...
	function onSubmit(data) {
		if (data?.reason === '...' || data?.reason === '') {
			...
			if (openDeleteReasonDialog === true) {
				dispatch(removeContainerType(submitData));
			}
		}
		handleClose();
	}
