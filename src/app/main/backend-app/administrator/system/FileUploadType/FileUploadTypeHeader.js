...
import { setSearchText, OpenNewFileUploadTypeDialog } from './store/fileUploadTypeSlice';

function FileUploadTypeHeader(props) {
	...
	return (
		<div className="flex flex-1 w-full items-center justify-between">
			...
			<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0, transition: { delay: 0.2 } }}>
				<Button
					onClick={() => {
						dispatch(OpenNewFileUploadTypeDialog());
					}}
...
export default FileUploadTypeHeader;
